...
public class OrderMediatRContext : DbContext, IOrderMediatRContext
{
    public OrderMediatRContext(DbContextOptions<OrderMediatRContext> options) : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Configuração para Value Objects
        ConfigureValueObjects(modelBuilder);

        // Aplicar configurações de entidade
    ...
    private static void ConfigureValueObjects(ModelBuilder modelBuilder)
    {
        ...
        // Configurar Payment com Money
        modelBuilder.Entity<Payment>(entity =>
        {
            // Payment.Amount já é decimal, não precisa de configuração especial de Value Object
        });
    }
}